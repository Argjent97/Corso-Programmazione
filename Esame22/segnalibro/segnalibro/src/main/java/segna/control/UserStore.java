...
import segna.security.SecurityEncoding;
import segna.boundary.Credential;
...
public class UserStore {
    ...
    public List<User> all(){
        ...
        return em.createQuery("select e from User e where e.cancellato = false").getResultList();
    ...
    return em.createQuery("select e from User e where e.cancellato = false order by e.lastName", User.class)
